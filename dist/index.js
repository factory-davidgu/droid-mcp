...
mcpServer.registerTool("droidExec", {
    ...
    inputSchema: {
        ...
        model: z
            .string()
            .optional()
            .describe("Model ID to use (default: claude-sonnet-4-5-20250929). Available: gpt-5.1-codex, gpt-5.1, gpt-5-codex, claude-sonnet-4-5-20250929, gpt-5-2025-08-07, claude-opus-4-1-20250805, claude-haiku-4-5-20251001, glm-4.6"),
    ...
    return new Promise((resolve) => {
        ...
        child.on("close", (code) => {
            if (code !== 0) {
                ...
                const cleanedOutput = stdout.replace(/^\x1b\[\?25l\x1b\[2K\x1b\[1G\x1b\[\?25h\x1b\[32m✓[^\n]*\x1b\[0m\n/, "");
                resolve({
                    content: [
                        {
                            type: "text",
